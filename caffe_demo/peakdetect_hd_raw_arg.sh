...
build/examples/rtpose/rtpose_han_hd.bin --rawDir $rawMainPath --num_gpu 4 --logtostderr --no_frame_drops --write_txt $mainPath/$savePath --num_scales 3 --scale_gap 0.15 --frame_start $frameStart --frame_end $frameEnd  --start_device 0 --cam_start 0 --cam_end 30  $mainPath/$savePath #--resolution 1920x1080
#parallel -j4 --xapply build/examples/rtpose/rtpose_han.bin --rawDir $rawMainPath --num_gpu 1 --logtostderr --no_frame_drops --write_txt $mainPath/$savePath --resolution 640x480 --num_scales 3 --scale_gap 0.15 --frame_start $frameStart --frame_end $frameEnd  --start_device {1} --panel_start {2} --panel_end {3} --start_device {1} --cam_sampleNum $camSamplingNum ::: 0 1 2 3 ::: 1 6 11 16 ::: 5 10 15 20
